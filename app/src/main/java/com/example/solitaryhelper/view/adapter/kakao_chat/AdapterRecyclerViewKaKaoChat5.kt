...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData5

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat5(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData5>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat5.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData5>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData5>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData5>) {
