...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData15

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat15(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData15>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat15.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData15>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData15>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData15>) {
