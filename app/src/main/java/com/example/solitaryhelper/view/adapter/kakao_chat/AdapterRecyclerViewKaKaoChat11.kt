...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData11

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat11(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData11>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat11.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData11>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData11>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData11>) {
