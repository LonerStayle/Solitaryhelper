...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData12

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat12(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData12>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat12.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData12>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData12>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData12>) {
