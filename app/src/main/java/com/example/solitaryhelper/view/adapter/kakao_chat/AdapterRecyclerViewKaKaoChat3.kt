...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData3

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat3(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData3>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat3.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData3>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData3>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData3>) {
