...
class AdapterRecyclerViewKaKaoChat10(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData10>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat10.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData10>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData10>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData10>) {
