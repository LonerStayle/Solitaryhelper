...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData8

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat8(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData8>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat8.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData8>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData8>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData8>) {
