...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData19

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat19(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData19>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat19.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData19>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData19>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData19>) {
