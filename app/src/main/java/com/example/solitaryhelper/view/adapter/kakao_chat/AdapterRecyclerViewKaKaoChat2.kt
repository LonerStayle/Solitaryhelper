...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData2

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat2(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData2>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat2.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData2>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData2>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData2>) {
