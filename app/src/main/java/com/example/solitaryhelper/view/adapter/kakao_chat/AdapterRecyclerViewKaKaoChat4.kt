...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData4

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat4(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData4>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat4.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData4>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData4>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData4>) {
