...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData6

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat6(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData6>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat6.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData6>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData6>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData6>) {
