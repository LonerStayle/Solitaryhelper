...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData16

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat16(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData16>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat16.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData16>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData16>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData16>) {
