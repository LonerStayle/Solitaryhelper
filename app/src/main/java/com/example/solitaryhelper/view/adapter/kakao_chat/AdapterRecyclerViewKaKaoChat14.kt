...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData14

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat14(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData14>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat14.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData14>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData14>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData14>) {
