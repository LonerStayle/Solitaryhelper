...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData1

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat1(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData1>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat1.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData1>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData1>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData1>) {
