...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData13

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat13(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData13>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat13.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData13>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData13>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData13>) {
