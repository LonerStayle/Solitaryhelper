...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData18

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat18(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData18>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat18.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData18>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData18>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData18>) {
