...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData17

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat17(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData17>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat17.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData17>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData17>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData17>) {
