...
import com.example.solitaryhelper.database.localdb.entitiy.KaKaoTalkChatData9

import com.example.solitaryhelper.view.utill.kakaoTimeDisplay

class AdapterRecyclerViewKaKaoChat9(
    var kaKaoProfile: String,
    var kaKaoName: String,
    var chatList: List<KaKaoTalkChatData9>

) : RecyclerView.Adapter<AdapterRecyclerViewKaKaoChat9.ViewHolder>() {
    ...
    inner class ViewHolder : RecyclerView.ViewHolder {
        ...
        fun setTimeVisible(timeVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData9>) {
        ...
        fun setProfileVisible(
            ...
            chatList: List<KaKaoTalkChatData9>
        ) {
        ...
        fun setNameVisible(nameVisibleList: MutableList<Int>, chatList: List<KaKaoTalkChatData9>) {
